 ...
 */
#ifndef FLUTTER_PLUGIN_AUDIO_SERVICE_MPRIS_PLUGIN_H
#define FLUTTER_PLUGIN_AUDIO_SERVICE_MPRIS_PLUGIN_H

#include <audio_service_mpris/encodable_helper.h>
...
class PLUGIN_EXPORT AudioServiceMprisPlugin final : public flutter::Plugin
{
public:
    static void RegisterWithRegistrar(PluginRegistrar* registrar);
    AudioServiceMprisPlugin(
...
#endif /* FLUTTER_PLUGIN_AUDIO_SERVICE_MPRIS_PLUGIN_H */
